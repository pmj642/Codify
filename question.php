              ...
              <div class="grid">
                ...
                <section class="col-2-3">
                    ...
                    <?php
                        ...
                        echo "<p style = '$color'>".nl2br(mb_convert_encoding($row["constraints"], "UTF-8"))."</p>";

                        echo "<h2 style = '$color'>Example</h2>";
                        echo "<h3 style = '$color'>Input</h3>";
                        echo "<p style = '$color'>".nl2br(mb_convert_encoding($row["examplein"],"UTF-8"))."</p>";
                        echo "<h3 style = '$color'>Output</h3>";
                        echo "<p style = '$color'>".nl2br(mb_convert_encoding($row["exampleout"],"UTF-8"))."</p>";
                        echo "</div>";
